...
from prers import TrafficVolumeResponses


class TestTrafficVolumeResponses(unittest.TestCase):

    def reinit(self):
        self.__stringbuffer1 = StringIO.StringIO()
        self.__p1 = TrafficVolumeResponses(self.__stringbuffer1)
    ...
    def test_data_example(self):
        ...
        for qvst in example.get_information('TrafficVolumeResponses'):
