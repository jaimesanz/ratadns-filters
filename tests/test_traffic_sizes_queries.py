...
from prers import TrafficSizesQueries


class TestTrafficSizesQueries(unittest.TestCase):

    def reinit(self):
        self.__stringbuffer1 = StringIO.StringIO()
        self.__p1 = TrafficSizesQueries(self.__stringbuffer1)
    ...
    def test_data_example(self):
        ...
        for qvst in example.get_information('TrafficSizesQueries'):
